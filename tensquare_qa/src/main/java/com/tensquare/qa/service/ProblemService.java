...
public class ProblemService {
     ...
     * @return
     */
    public Page<Problem> newProblems(String lableid, int page, int size) {
        PageRequest pageRequest = PageRequest.of(page - 1, size);
        return problemDao.newProblems(lableid, pageRequest);
    }
     ...
     * @return
     */
    public Page<Problem> hotList(String lableid, int page, int size) {
        PageRequest pageRequest = PageRequest.of(page - 1, size);
     ...
     * @return
     */
    public Page<Problem> waitlist(String lableid, int page, int size) {
        PageRequest pageRequest = PageRequest.of(page - 1, size);
